...
/// returns HH:MM:SS
inline std::string ms_to_hhmmss( unsigned int time_ms )
{
...
/// returns HH:MM:SS.MS
inline std::string ms_to_hhmmssms( unsigned int time_ms )
{
...
/// returns HH:MM:SS.FF
inline std::string ms_to_hhmmssff( unsigned int time_ms )
{
